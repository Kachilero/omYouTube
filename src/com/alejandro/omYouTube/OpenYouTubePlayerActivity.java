...
public class OpenYouTubePlayerActivity extends Activity {
    ...
    public final static String MSG_INIT         ="com.alejandro.video.msg.inti";
    protected String      mMsgInit              = "Initializing";

    public final static String MSG_DETECT       = "com.alejandro.video.msg.detect";
    protected String      mMsgDetect            = "Detecting Bandwidth";

    public final static String MSG_PLAYLIST     = "com.alejandro.video.msg.playlist";
    protected String      mMsgPlaylist          = "Determining Latest Video in YouTube Playlist";

    public final static String MSG_TOKEN        = "com.alejandro.video.msg.token";
    protected String      mMsgToken             = "Retrieving YouTube Video Token";

    public final static String MSG_LO_BAND      = "com.alejandro.video.msg.loband";
    protected String      mMsgLowBand           = "Buffering Low-bandwidth Video";

    public final static String MSG_HI_BAND      = "com.alejandro.video.msg.hiband";
    protected String      mMsgHiBand            = "Buffering High-bandwidth Video";

    public final static String MSG_ERROR_TITLE  = "com.alejandro.video.msg.error.title";
    protected String      mMsgErrorTitle        = "Communications Error";

    public final static String MSG_ERROR_MSG    = "com.alejandro.video.msg.error.msg";
    ...
    private void setupView() {
        ...
        LinearLayout.LayoutParams lLinLayoutParms = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
    ...
    private class QueryYouTubeTask extends AsyncTask<YouTubeId, ProgressUpdateInfo, Uri> {
        ...
        private void showErrorAlert() {
            ...
            try {
                AlertDialog.Builder lBuilder = new AlertDialog.Builder(OpenYouTubePlayerActivity.this);
